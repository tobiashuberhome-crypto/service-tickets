# Datei: resources\views\customer-portal-geiser\delivery-note.blade.php

> **Kommentar:** Automatischer Export des finalen Dateistands fuer Dokumentationszwecke.

- **Quelle:** `resources\views\customer-portal-geiser\delivery-note.blade.php`
...
<body>
    ...
    <div class="signature">
        <p>Unterschrift EmpfÃ¤nger: ___________________________________________</p>
    </div>
</body>
</html>
```

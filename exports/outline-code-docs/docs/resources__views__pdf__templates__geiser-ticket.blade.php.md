# Datei: resources\views\pdf\templates\geiser-ticket.blade.php

> **Kommentar:** Automatischer Export des finalen Dateistands fuer Dokumentationszwecke.

- **Quelle:** `resources\views\pdf\templates\geiser-ticket.blade.php`
...
@section('subtitle', 'Geiser-Serviceportal Â· Ticket '.$ticket->ticket_number)

# Datei: app\Services\Pdf\PdfDocumentService.php

> **Kommentar:** Automatischer Export des finalen Dateistands fuer Dokumentationszwecke.

- **Quelle:** `app\Services\Pdf\PdfDocumentService.php`
...
class PdfDocumentService
{
    public function generateAndStore(string $templateKey, array $data, array $filenameContext = [], array $overrides = []): array
    {
            ...
            if (! class_exists(\Barryvdh\DomPDF\Facade\Pdf::class)) {
                throw new InvalidArgumentException('PDF-Generator (barryvdh/laravel-dompdf) ist nicht installiert. FÃ¼hre composer require barryvdh/laravel-dompdf aus.');
            }

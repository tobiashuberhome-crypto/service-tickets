# Datei: resources\views\customer-portal-geiser\password-reset.blade.php

> **Kommentar:** Automatischer Export des finalen Dateistands fuer Dokumentationszwecke.

- **Quelle:** `resources\views\customer-portal-geiser\password-reset.blade.php`
- **Stand:** 2026-06-30 19:32:06
- **Typ:** blade
...
@section('content')
    ...
    <div class="panel panel-body stack" style="max-width: 640px;">
        <form method="post" action="{{ route('geiser-portal.password.reset', ['token' => $token]) }}" class="stack">
            @csrf
            <div>
                <label>E-Mail</label>

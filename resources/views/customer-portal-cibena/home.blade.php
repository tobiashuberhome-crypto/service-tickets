    ...
    <div class="grid grid-2">
        ...
        <aside class="panel panel-body stack">
            ...
            @if ($account)
                ...
                <a class="btn" href="{{ route('cibena-portal.dashboard') }}">Zu meinen Tickets</a>
            @else
                <p class="muted">Melden Sie sich mit E-Mail und Passwort an oder nutzen Sie alternativ einen Magic Link.</p>
                <a class="btn" href="{{ route('cibena-portal.login') }}">Jetzt anmelden</a>
            @endif
        </aside>
    </div>
@endsection

...
@section('content')
    <div class="page-header">
        <div>
            ...
            <h1>Login fuer Cibena-Serviceportal</h1>
    ...
    <div class="panel panel-body stack" style="max-width: 640px; margin-bottom: 1rem;">
        ...
        <form method="post" action="{{ route('cibena-portal.password.login') }}" class="stack">
            @csrf
            <div>
        ...
        <form method="post" action="{{ route('cibena-portal.password.reset.send') }}" class="stack">
            @csrf
            <div>
    ...
    <div class="panel panel-body stack" style="max-width: 640px">
        ...
        <form method="post" action="{{ route('cibena-portal.magic.send') }}" class="stack">
            @csrf
            <div>
